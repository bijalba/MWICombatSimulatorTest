class CombatUnit {
    ...
    clearCCs() {
        ...
        this.cursePercentage = 0;
        this.isWeakened = false;
        this.weakenExpireTime = null;
        this.weakenPercentage = 0;
        this.hasFury = false;
        this.furyExpireTime = null;
        this.furyPercentage = 0;
    }
